...
#    Updated: 2016/05/06 16:43:15 by guiricha         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC_NAME = main.c linked_lists.c test_funcs.c test_funcs2.c print_funcs.c \
		   linked_lists_actions.c linked_lists_actions_2.c apply_actions.c \
		   algo.c algo2.c linked_lists2.c linked_lists3.c
